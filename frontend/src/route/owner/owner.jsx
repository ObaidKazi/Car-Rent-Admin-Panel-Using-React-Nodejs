...
function Owner(props){
    ...
    useEffect(()=>{
        ...
        fetch(environment.apiPrefix+'/getCurrentUserCar/'+props.match.params.id,requestOptions).then((response) => response.json())
        .then((content) => {
            let carArray=[];
    ...
    return (
        <Fragment>
            <Content title="Owner Cars" browserTitle="Owner Cars">
                <Row>
